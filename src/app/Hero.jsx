    ...
    >
      ...
      >
        <div className="relative z-1 mx-auto mb-[3.875rem] max-w-[62rem] text-center md:mb-20 lg:mb-[6.25rem]">
          <h1 className="h1 mb-6" itemProp={"description"}>
            Explore the Possibilities of Cloud Infrastructure&nbsp;&amp; Security with {` `}
            <span className="relative inline-block" itemProp={"name"}>
              Octopi{" "}
              <Image
                src={curve}
        ...
        <div className="relative mx-auto max-w-[23rem] md:max-w-5xl xl:mb-24">
          <div className="relative z-1 rounded-2xl bg-conic-gradient p-0.5">
            <div className="relative rounded-[1rem] bg-n-8">
              ...
              <div className="aspect-[33/40] overflow-hidden rounded-b-[0.9rem] md:aspect-[688/490] lg:aspect-[1024/490]">
                ...
                <ScrollParallax isAbsolutelyPositioned>
                  <Notification
                    className="absolute -right-[5.5rem] bottom-[11rem] hidden w-[19rem] xl:flex"
                    title="Deployed Octopi app"
                  />
                </ScrollParallax>
              </div>
            </div>
          ...
          <div className="absolute -top-[54%] left-1/2 -z-10 w-[234%] -translate-x-1/2 md:-top-[46%] md:w-[138%] lg:-top-[104%]">
